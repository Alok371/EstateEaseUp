            ...
            <form className='flex flex-col sm:flex-row gap-4 '>
                ...
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    <div className='flex gap-6 flex-wrap'>
                        ...
                        <div className='flex items-center gap-2'>
                            <input type="number" id="regularPrice" min="0" required className='p-3 border border-gray-300 rounded-lg' />
                        ...
                        <div className='flex items-center gap-2'>
                            <input type="number" id="dicountPrice" min="0" required className='p-3 border border-gray-300 rounded-lg' />
                            <div className='flex flex-col items-center'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    <p className='font-semibold'>Image: <span className='font-normal text-gray-600 ml-2'>The first image will be the cover (max 6)</span>
                    </p>
