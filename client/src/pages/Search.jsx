            ...
            <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
                <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                    ...
                    <div className='flex gap-2 flex-wrap items-center'>
                        ...
                        <div className='flex gap-2'>
                            <input onChange={handleChange}
                                checked={sidebardata.type === 'sell'} type='checkbox' id='sell' className='w-5 ' />
                            <span>Sell</span>
                        </div>
                        <div className='flex gap-2'>
                            <input onChange={handleChange}
                                checked={sidebardata.offer} type='checkbox' id='offer' className='w-5 ' />
                            <span>Offer</span>
                        </div>
                    ...
                    <div className='flex gap-2 flex-wrap items-center'>
                        ...
                        <div className='flex gap-2'>
                            <input onChange={handleChange}
                                checked={sidebardata.furnished} type='checkbox' id='furnished' className='w-5 ' />
                            <span>Furnished</span>
                        </div>
